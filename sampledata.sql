...
-- Insert vào bảng Employee_Roles
INSERT INTO Employee_Roles (employee_id, role_id) VALUES 
(1, 1),  -- John Doe là Admin
(2, 2),  -- Jane Smith là Manager
(3, 3);  -- Alice Johnson là Employee

-- Insert vào bảng Role_Features
INSERT INTO Role_Features (role_id, feature_id) VALUES 
(1, 1), -- Admin có quyền Manage Employees
(2, 2), -- Manager có quyền Approve Leave Requests
(3, 3); -- Employee có quyền View Work Schedule
...
-- Insert vào bảng Leave_Request_History
